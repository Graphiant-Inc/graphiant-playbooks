...
- **Verification:**
  - Collection version: `26.2.3` (meets requirement: >= 1.0.0)
...
- **Verification:**
  - Version `26.2.3` is specified in `galaxy.yml`
...
- **Verification:**
  - Current version: `26.2.3` (follows semantic versioning)
