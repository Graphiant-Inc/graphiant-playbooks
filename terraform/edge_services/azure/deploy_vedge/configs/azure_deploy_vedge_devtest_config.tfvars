# Azure Deploy vEdge Configuration - Devtest mode (Internal Use Only)
...
# ================================================================
# resource_group_id = "/subscriptions/xxxx/resourceGroups/graphiant-vedge-devtest-rg"
resource_group_name = "graphiant-vedge-devtest-rg"
...
# When set, overrides the Marketplace image
...
# ssh_public_key: SSH public key (required by Azure; used for interactive SSH access in devtest mode)
ssh_public_key = ""
...
vnet_name = "graphiant-vedge-devtest-vnet"
vnet_address_space = "10.1.0.0/16"

# cloud-init subnet (devtest only): provide subnet_cloud_init_id to use existing, or subnet_cloud_init_prefix to create new
# subnet_cloud_init_id = "/subscriptions/xxxx/resourceGroups/rg/providers/Microsoft.Network/virtualNetworks/vnet/subnets/cloud-init"
subnet_cloud_init_prefix = "10.1.0.0/24"
...
# ================================================================
# Route Tables: provide route_table_*_id to use existing (e.g. from deploy_vnet), or leave empty to create new
# ================================================================
...
# allowed_cidr: Public IPv4 allowed to connect to the devtest cloud-init SSH port
allowed_cidr = "0.0.0.0/0"

# allowed_cidr_v6: Public IPv6 allowed to connect to the devtest cloud-init SSH port
allowed_cidr_v6 = "::/0"
